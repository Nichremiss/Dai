<html lang="en">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-custom">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ddl_medico" class="select2" data-allow-clear="true" data-placeholder="" id="ddl_medico" style="display: block;
                                                                width: 100%;
                                                                height: 34px;
                                                                padding: 6px 12px;
                                                                font-size: 14px;
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ddl_Paciente" class="select2" data-allow-clear="true" data-placeholder="" id="ddl_Paciente" style="display: block;
                                                                width: 100%;
                                                                height: 34px;
                                                                padding: 6px 12px;
                                                                font-size: 14px;
        ...
        <form action="" method="POST">
            ...
            <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                <h2 class="h-ultra">Lista de Reservas</h2>
            </div>
