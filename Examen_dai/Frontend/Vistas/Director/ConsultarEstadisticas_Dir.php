                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                                <h2 class="h-ultra">Consulta de estadísticas</h2>
                            </div>
                            <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
                                <h6 class="h-light">Información confidencial</h6>
                            </div>
                            <div class="well well-trans">
                                <div class="wow fadeInRight" data-wow-delay="0.1s">
                                    ...
                                    <ul class="lead-list">
                                        <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                                            <h5 class="h-ultra">Estadisticas</h5>
                                        </div>
                                        <div class="row">
                                            
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                   <input type="submit" style="margin-top: 25px" class="btn btn-skin btn-lg" value="N° Pacientes Registrados"><i class="fa fa-angle-right"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" name="txtRes" disabled="true"id="txtRes"  class="form-control input-md" data-rule="minlen:3" data-msg="Please enter at least 3 chars">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                   <input type="submit" style="margin-top: 25px" class="btn btn-skin btn-lg" value="N° Usuarios Registrados"><i class="fa fa-angle-right"></i>
                                                </div>
                                            </div>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                   <input type="submit" style="margin-top: 25px" class="btn btn-skin btn-lg" value="N° Consultas Atendidas"><i class="fa fa-angle-right"></i>
                                                </div>
                                            </div>
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4">
                                                <div class="form-group">
                                                   <input type="submit" style="margin-top: 25px" class="btn btn-skin btn-lg" value="N° Atenciones perdidas"><i class="fa fa-angle-right"></i>
                                                </div>
                                            </div>
