                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                                <h2 class="h-ultra">Consulta Atenciones</h2>
                            </div>
                            ...
                            <div class="well well-trans">
                                <div class="wow fadeInRight" data-wow-delay="0.1s">
                                    ...
                                    <ul class="lead-list">
                                        ...
                                        <p class="lead-footer">* Para mayor información comuniquese con nosotros +562 008 65 001</p>
